...
const { duxbot } = require('./virtex/jobot')
const { duxbot2 } = require('./virtex/jobot2')
...
wm = 'DUX BOT'
// Time & Date
const time2 = moment().tz('Africa/Algiers').format('HH:mm:ss')
if(time2 < "23:59:00"){
...
const time = moment(Date.now()).tz('Africa/Algiers').locale('id').format('HH:mm:ss z')
...
const salam = moment(Date.now()).tz('Africa/Algiers').locale('id').format('a')
...
user.afkReason = ''
	    ...
	    case 'yuhu': {
                ...
                user.afkReason = text
                m.reply(`${m.pushName} My Name AMPAZ || REACT${text ? ': ' + text : ''}`)
            }
            break
case 'hihi': {
if (!isCreator) return
...
m.reply(`╭━━•›ꪶ ཻུ۪۪ꦽꦼ̷⸙ ━ ━ ━ ━ ꪶ ཻུ۪۪ꦽꦼ̷⸙‹•━━╮\n┃╭┈─────────────⩵꙰ཱི࿐\n┃╰── ⏤͟͟͞Script Bot ──➤ ↶↷\n╰━━•›ꪶ ཻུ۪۪ꦽꦼ̷⸙ ━ ━ ━ ━ ꪶ ཻུ۪۪ꦽꦼ̷⸙‹•━━͙✩̣̣̣̣\n ▬▭▬▭▬ ✦✧✦ ▬▭▬▭▬\n╭━━•›\n│➳ Subscribe Channel\n│➳ AMPAZ || REACTION\n│➳ https://youtube.com/channel/UC70hSzmA3HAlSUilSDePr8w\n│➳ Grup Viruz\n│➳Blanz Viruz Ipmanz\n│➳ https://chat.whatsapp.com/ETQhk8Ej4BaClCAwp0BsV0\n╰━ ━ ━ ━ ━ ━ ━ ━ ━ ━•⩵꙰ཱི࿐\n ▬▭▬▭▬ ✦✧✦ ▬▭▬▭▬\n@ 𝕯U͜͡𝖃-𝕭𝕺𝙏𐃕𝆂📵𝆂𝆬𐃕 `)
            asa = await getBuffer(`http://hadi-api.herokuapp.com/api/tts?text=Hai Gaes ini Script Bot V 3 Dan Subrek yutub ampaz reaction&language=id`)
...
•━══〘𝚃𝙷𝙴𝙹𝙾𝙱𝙾𝚃〙══━• \nINFO: ${q ? q : 'kosong'}\n•━══ DUX𐃕𝆂📵𝆂𝆬𐃕𝐑𝐄𝆂𝆬𝐀𝐂𝐓𝆬 ══━• \n`
                ...
                asa = await getBuffer(`http://hadi-api.herokuapp.com/api/tts?text= hallo gaes yang punya Esce V 3 Ini bisa main buk war dan bisa liat bokep&language=id`)
jobotz.sendMessage(m.chat, {audio: asa, mimetype: 'audio/mpeg', ptt:true })
}
break
                case 'hidetag': {
...
wlcm.push(from)
m.reply('Succes menjalankan welcome di group ini ')
} else if (args[0] === "off") {
             ...
             break
                case 'listgc': {
                 ...
                 for (let i of anu) {
                     ...
                     teks += `⬡ *Nama :* ${metadata.subject}\n⬡ *Owner :* ${metadata.owner !== undefined ? '@' + metadata.owner.split`@`[0] : 'Tidak diketahui'}\n⬡ *ID :* ${metadata.id}\n⬡ *Dibuat :* ${moment(metadata.creation * 1000).tz('Africa/Algiers').format('DD/MM/YYYY HH:mm:ss')}\n⬡ *Member :* ${metadata.participants.length}\n\n────────────────────────\n\n`
                 }
                 jobotz.sendTextWithMentions(m.chat, teks, m)
             }
             break
...
asa = await getBuffer(`http://hadi-api.herokuapp.com/api/tts?text=Selamat Datang Selamat Menikmati Di Menu Bot V 3  Dan ketik Bug Menu untuk melihat fitur bug jahat dan ketik Esce Untuk Mengambil Sekripnya paham&language=id`)
jobotz.sendMessage(m.chat, {audio: asa, mimetype: 'audio/mpeg', ptt:true })
}
break
case 'listmenu':{
...
│➳ ${prefix}peler (jumlah)
│➳ ${prefix}duxpay (jumlah)
│➳ ${prefix}duxtrol (jumlah)
│➳ ${prefix}duxtroli (jumlah)
│➳ ${prefix}kontol (jumlah)
│➳ ${prefix}kuntul (jumlah)
│➳ ${prefix}duxdocu (jumlah)
│➳ ${prefix}duxhello (jumlah)
│➳ ${prefix}duxlokas (jumlah)
│➳ ${prefix}monyet (jumlah)
│➳ ${prefix}duxmomo (jumlah)
│➳ ${prefix}duxbugpc (jumlah)
│➳ ${prefix}duxbugvn (jumlah)
│➳ ${prefix}duxtroliv2 (jumlah)
│➳ ${prefix}duxliveloc (jumlah)
│➳ ${prefix}duxbuglist (jumlah)
│➳ ${prefix}duxtagwae (jumlah)
│➳ ${prefix}duxcatalog (jumlah)
│➳ ${prefix}duxbugstik (jumlah)
│➳ ${prefix}duxthelima (jumlah)
│➳ ${prefix}crashcok (jumlah)
│➳ ${prefix}duxbutton (jumlah)
│➳ ${prefix}duxbugloc (jumlah)
│➳ ${prefix}duxbugdoc (jumlah)
│➳ ${prefix}duxlivelocv2 (jumlah)
│➳ ${prefix}duxbuginvite (jumlah)
│➳ ${prefix}duxbugstikv2 (jumlah)
│➳ ${prefix}duxcatalogv2 (jumlah)
│➳ ${prefix}duxbugbutton (jumlah)
│➳ ${prefix}duxbuttonbro (jumlah)
│➳ ${prefix}duxtengkorak (jumlah)
...
╰─────────────────╮
╭─────────────────╯
│➳ ${prefix}duxvnto (Nomer) 
│➳ ${prefix}kintilto (Nomer)
│➳ ${prefix}duxbutto (Nomer) 
│➳ ${prefix}duxstikto (Nomer) 
│➳ ${prefix}duxtrolito (Nomer)
│➳ ${prefix}kontolto (Nomer)
│➳ ${prefix}kuntulto (Nomer)
│➳ ${prefix}duxhelloto (Nomer)
│➳ ${prefix}duxsantetto (Nomer) 
│➳ ${prefix}duxmomoto (Nomer) 
│➳ ${prefix}duxbuglocto (Nomer)
│➳ ${prefix}duxinfiniteto (Nomer) 
│➳ ${prefix}duxbuttonto (Nomer)
│➳ ${prefix}duxlivelocto (Nomer)
│➳ ${prefix}duxbugdocto (Nomer)
│➳ ${prefix}duxbuginviteto (Nomer)
│➳ ${prefix}duxtengkorakto (Nomer) 
╰─────────────────╮
𐂠▰▱𝕯U͜͡𝖃-𝕭𝕺𝙏𐃕𝆂📵𝆂𝆬𐃕▱▰𐂠
╭─────────────────╯
│ ◪〘 MENU ATTACK2 〙◪
╰─────────────────╮
╭─────────────────╯
│➳ ${prefix}duxgasvn (Nomer) 
│➳ ${prefix}duxgasstik (Nomer) 
│➳ ${prefix}duxgastroli (Nomer)
│➳ ${prefix}duxgaskintil (Nomer)
│➳ ${prefix}duxgashello (Nomer) 
│➳ ${prefix}duxgaskintol (Nomer)
│➳ ${prefix}duxgaskuntul (Nomer)
│➳ ${prefix}duxgasmomo (Nomer) 
│➳ ${prefix}duxgassantet (Nomer) 
│➳ ${prefix}duxgasinfinite (Nomer) 
│➳ ${prefix}duxgasliveloc (Nomer)
│➳ ${prefix}duxgasbutton (Nomer)
│➳ ${prefix}duxgasbugloc (Nomer)
│➳ ${prefix}duxgastengkorak (Nomer) 
╰─────────────────╯
𐂠▰▱𝕯U͜͡𝖃-𝕭𝕺𝙏𐃕𝆂📵𝆂𝆬𐃕▱▰𐂠
  ▰▱▰▱▰▱▰▱▰▱▰▱▰
...
image = fs.readFileSync('./lib/jo.jpg'),
jobotz.sendMessage(m.chat, { image: image, contextInfo: { mentionedJid: [m.key] }, caption: anu })
asa = await getBuffer(`http://hadi-api.herokuapp.com/api/tts?text= Ini buk Menu Bot V 3  Dan ketik  Menu buk jahatnya buat serang watsap mantan mantan kamu&language=id`)
jobotz.sendMessage(m.chat, {audio: asa, mimetype: 'audio/mpeg', ptt:true })
}
break
case 'bokep':{
